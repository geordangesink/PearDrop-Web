...
test('web app real relay path downloads from bare-backed native uploader', { timeout: 120000 }, async (t) => {
  const tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), 'peardrops-web-real-e2e-'))
